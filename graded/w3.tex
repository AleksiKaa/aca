...
\begin{enumerate}
    ...
    \item Let $\alpha = sB^e \sum_{i = 0}^{d - 1} \alpha_i B^{-i}$ and $\tilde{\alpha} = \tilde{s}B^{\tilde{e}}\sum_{i = 0}^{\tilde{d} - 1}
          ...
          \begin{enumerate}
              ...
              \begin{align*}
                & sB^{e - d + 1 - c} \sum_{i = 0}^{d - 1} \alpha_i B^{d - 1 - i + c} + \tilde{s}B^{e - d + 1 - c} \sum_{i = 0}^{d - 1} \tilde{\alpha}_i B^{d - 1 + \tilde{e} - e - i + c} \\
                = & sB^{e - d + 1 - c} \left( \sum_{i = 0}^{d - 1} \alpha_i B^{d - 1 - i + c} + \sum_{i = 0}^{d - 1} \tilde{\alpha}_i B^{d - 1 + \tilde{e} - e - i + c} \right)
              \end{align*}
